...
skill_navigation:
  ...
  project_rules:
    - "初始假设必须包含真正挑战核心命题的合理替代解释 — 见 INVESTIGATION-HANDBOOK.md §1.3 假设管理"
...
| 假设编号 | 假设内容 | 角色 | 支持/证伪方法 |
|---------|---------|------|--------------|
| H1 | [假设] | 指控性解释/合理替代解释 | [支持性预测 + 反驳条件 + 区分性证据] |

> ⚠️ 根据项目规范，应形成最小充分的竞争假设集（通常 3-5 个）。五类假设用于覆盖检查而非数量配额，并且必须包含至少一个真正挑战核心命题的合理替代解释。
